#!/usr/bin/env python3
"""
Набор проверок CRUD и состояния БД без запуска uvicorn (консольный вывод).

Использует тот же engine, что и приложение (database.engine).
Для автоматических тестов предпочтительнее ``pytest tests/``.
"""
import sys
